...
// FakeServer.cpp  TemporaryData.cpp
// [MP] , 
//  DLL , 
...
// [MP] /( FakeServer.cpp / StandaloneServer.cpp)
...
bool MP_SmoothMove();
// [v186] Raw relay of non-movement game packets (emote/attack/skill/chat/
// player-shop flags, ...) to same-map peers. 8th char of mp_ctx.cfg.
// Default OFF: only used as a diagnostic sniffer until the shop protocol is
// understood; flip to '1' to relay verbatim (may misrender on the receiver).
bool MP_RawRelay();
